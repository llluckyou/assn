        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center inner">
                <div class="animatedParent">
                    <h1 class="animated fadeInDown">社团联合会</h1>
                    <p class="animated fadeInUp">Push it</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center">
                <a href="#about" class="learn-more-btn btn-scroll">开始吧</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2 animatedParent">
                <div class="text-center">
                    <p>
                        如果有任何意见或建议，请联系我们，我们将会做得更好。
                    </p>

                    <a href="#service" class="btn btn-skin btn-scroll">干点什么</a>
                </div>
            </div>
                    ...
                    <div class="animated rotateInDownLeft">
                        <div class="service-box">
                            ...
                            <div class="service-desc">
                                ...
                                <a href="#" class="btn btn-skin">了解更多</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <div>
                    <div class="animatedParent">
                        <div class="section-heading text-center">
                            <h2 class="h-bold animated bounceInDown">热门活动</h2>
                            <div class="divider-header"></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container marginbot-50">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <div class="animatedParent">
                    <div class="section-heading text-center">
                        <h2 class="h-bold animated bounceInDown">和我们联系</h2>
                        <div class="divider-header"></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row marginbot-20">
                        <div class="col-md-6 xs-marginbot-20">
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" id="name" placeholder="你的名字"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="message" rows="5" data-rule="required"
                                          data-msg="Please write something for us" placeholder="消息"></textarea>
                                <div class="validation"></div>
                            </div>
